...
QT_MOC_LITERAL(1, 13, 15), // "ReceiveResponse"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 4) // "data"

    },
    "SerialThread\0ReceiveResponse\0\0data"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ReceiveResponse((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialThread::ReceiveResponse)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialThread::ReceiveResponse(const QByteArray & _t1)
{
